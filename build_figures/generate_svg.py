...
OUT = Path(__file__).parent / "figures/chapter2/diagrams"
OUT.mkdir(parents=True, exist_ok=True)
svg_path = OUT / "specparam_parameterization.svg"
pdf_path = OUT / "specparam_parameterization.pdf"

svg_content = "\n".join(svg)
svg_path.write_text(svg_content)

# Raw SVG -> PDF for the LaTeX build (lualatex can't embed SVG directly).
